...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 43.0, 36.0, 66.0, 22.0 ],
									"text" : "script start"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 144.0, 122.0, 79.0, 22.0 ],
									"text" : "route running"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 204.0, 179.0, 400.0, 220.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 43.0, 75.0, 120.0, 35.0 ],
									"saved_object_attributes" : 									{
										"autostart" : 1,
										"defer" : 0,
										"node_bin_path" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 43.0, 369.0, 30.0, 30.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 342.0, 527.0, 40.0, 112.0 ],
					"relative" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 342.0, 660.0, 54.0, 22.0 ],
					"text" : "mc.dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 342.0, 472.0, 158.0, 33.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					"data" : 					{
						...
						"/source/1/aed" : [ 42.947677612304688, 1.126727938652039, 2.941176414489746 ],
						...
						"/display/zoom" : 44.312389373779297,
...
, 			{
		...
		"parameters" : 		{
			"obj-16" : [ "mc.live.gain~[2]", "speakers", 0 ],
...
, 			{
				"name" : "server.js",
				"bootpath" : "~/University/Projekte/Klangdom-MSL/sounddome-hoa",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
